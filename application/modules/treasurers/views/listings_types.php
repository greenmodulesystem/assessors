...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Types of Business</li>
        </ol>
    </section>
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
                <div class="box-title">
                    <h3 class="box-title"><i class="fa fa-list-alt"></i> Types of Business Listing</h3>
                </div>
                <div class="box-tools">
                    <div class="row form-inline" style="padding-right:10px">
                        <select style="width:120px;" class="js-example-basic-single" id="Class">
                            <option disabled selected value="">Filter Year</option>
                            <option value="">All</option>
                            <?php for($x = 2018; $x <= date('Y'); $x++) {?>
                                <option value="<?=$x?>"><?=$x?></option>
                            <?php } ?>
                        </select>&emsp;
                        <input type="text" id="Barangay" value='' hidden>
            ...
            <div class="box-body">
                <div class="col-md-6">
                    <h5 class="box-title"><b>NUMBER AND TYPE OF BUSINESS ESTABLISHMENTS</b></h5>
                ...
                <div class="col-md-6">
                    <h5 class="box-title"><b>SUMMARY OF NUMBER AND TYPE OF BUSINESS ESTABLISHMENTS</b></h5>
                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <tbody id="grid2">
                        </tbody>
                    </table>
...
<script language="javascript">
    ...
    var loadGrid = function(){
        $(document).gmLoadPage({
            url     :   baseUrl+"treasurers/listings_types_all/",
            load_on :   "#grid"
        });
        
        $(document).gmLoadPage({
            url     :   baseUrl+"treasurers/listings_types_summary/",
            load_on :   "#grid2"
        });
    }

    $('#Filter').gmFilter({
        url     :   baseUrl+"treasurers/listings_types_all_filter",
        brgy    :   "#Barangay",
        class   :   "#Class",
        from    :   "#From",
        to      :   "#To",
    ...
    $('#Filter').gmFilter({
        url     :   baseUrl+"treasurers/listings_types_summary_filter",
        brgy    :   "#Barangay",
        class   :   "#Class",
        from    :   "#From",
        to      :   "#To",
