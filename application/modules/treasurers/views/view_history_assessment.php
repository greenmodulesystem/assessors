...
<?php
    ...
    $Status = ($bill_fees != null) ? 'RENEW' : 'NEW';
    $Type = $Status." (".$cycle_year.")";
...
<div class="doc" style="line-height:.6em; width:21.6cm; display:inline-block; left:in;">
    ...
    <div style="text-align: center;">
        <p>REPUBLIC OF THE PHILIPPINES <?=($bill_fees != null) ? 'RENEW' : 'NEW';?></p>
        <p>CITY OF SAGAY</p>
    ...
    <div class="thisfoot">
        ...
        <p> PRINTED BY : <input style="width:100px;border-style: none;" class="sm permit-info text-center"
			value="<?=strtoupper($user->First_name." ".$user->Last_name)?>">&emsp;
            PRINT DATE : <input style="width:100px;border-style: none;" class="sm permit-info text-center" 
				value="<?=date('Y-m-d H:i:s')?>"></p>
    </div>
</div>