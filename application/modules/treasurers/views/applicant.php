                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="list-group list-group-unbordered text-center">
                            ...
                            <?php if ($arrears != null) {
                                ...
                                $year = substr($years, 0, -1);
                            ?>
                                <div class="callout callout-danger" style="width:30%;margin-left:35%;margin-bottom:-20px;">
                                    <h4 style="padding-top:65px;margin-bottom:-5px">
                                        <i class="icon fa fa-exclamation"></i> WITH ARREARS (<?= $year ?>)
                                    </h4>
                                </div>
                            <?php } ?>
                            <div class="pull-left"><?php echo ($arrears != null) ? '' : '<br>' ?>
                            ...
                            <div class="pull-right"><?php echo ($arrears != null) ? '' : '<br>' ?>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <?php foreach ($blines as $key => $bline) { ?>
                                        <p><?php if ($bline->Assessment_asset_ID == null) { ?>
                                            ...
                                            <?php } else { ?>
                                                <input id="xmp<?= $key ?>" type="checkbox" class="form-check-input exempt" disabled <?= ($bline->Exempted) ? 'checked' : '' ?>>
                                            <?php } ?>
                                            <?= $bline->Business_line ?>
                                        </p></br>
                                    <?php } ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group text-right">
                                        ...
                                        <?php foreach ($blines as $key => $bline) { ?>
                                            ...
                                            <div class="<?= ($bline->Essential == null && $bline->NonEssential == null) ? 'cap_input' : ''; ?>" style="display:none">
                                                <input class="input-field cap-edit form-control input-sm 
                                                text-right" type="number" min="1" disabled step="0.01" value="<?= $bline->Capitalization ?>" id="cap<?= $key ?>" data-id="<?= $key ?>"></br>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                                        ...
                                        <?php foreach ($blines as $key => $bline) { ?>
                                            <?php if ($bline->Assessment_asset_ID == null) { ?>
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <?php } ?>
                                                    <?php foreach ($asset_size_r as $key => $asset) { ?>
                                        ...
                                        <?php foreach ($blines as $key => $bline) {
                                            ...
                                            <?php } else if ($bline->Essential == null) { ?>
                                                ...
                                                <div class="gross_input" style="display:none">
                                                    <input class="input-field gross-edit form-control input-sm text-right" type="number" min="1" disabled value="0" step="0.01" id="ess<?= $key ?>"></br>
                                                </div>
                                            <?php } else { ?>
                                                <div class="gross_text">
                                                ...
                                                <div class="gross_input" style="display:none">
                                                    <input class="input-field gross-edit form-control input-sm text-right" type="number" min="1" disabled value="<?= $bline->Essential ?>" step="0.01" id="ess<?= $key ?>"></br>
                                                </div>
                                        <?php }
                                        } ?>
                                    </div>
                                    ...
                                    <div class="form-group text-right">
                                        ...
                                        <?php foreach ($blines as $key => $bline) {
                                            ...
                                            <?php } else if ($bline->NonEssential == null) { ?>
                                                ...
                                                <div class="gross_input" style="display:none">
                                                    <input class="input-field gross-edit form-control input-sm text-right" type="number" min="1" disabled value="0" step="0.01" id="non<?= $key ?>"></br>
                                                </div>
                                            <?php } else { ?>
                                                <div class="gross_text">
                                                ...
                                                <div class="gross_input" style="display:none">
                                                    <input class="input-field gross-edit form-control input-sm text-right" type="number" min="1" disabled value="<?= $bline->NonEssential ?>" step="0.01" id="non<?= $key ?>"></br>
                                                </div>
                                        <?php }
                                        } ?>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input id="Employees" type="number" min="1" disabled class="input-field form-control input-sm text-right" value="<?= $profiles->Total_number_employees ?>" style="width:70%">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-inline">
                                            <?php if ($No_record) { ?>
                                                ...
                                                <input id="Flammable" type="number" min="1" disabled class="form-control input-sm text-right" value="" style="width:70%">
                                            <?php } else { ?>
                                                <input id="Flame" type="checkbox" class="form-check-input" disabled <?= ($details->Flammable != 0) ? 'checked' : '' ?>>&emsp;
                                                <input id="Flammable" type="number" min="1" disabled class="form-control input-sm text-right" value="<?= $details->Flammable ?>" style="width:70%">
                                            <?php } ?>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Trucking Permit Fee:</label></br>
                                        <div class="form-inline">
                                            <?php if ($No_record) { ?>
                                                <input id="Trucking" type="checkbox" class="form-check-input">&emsp;
                                                <input id="Trucking_Fee" type="number" min="1" disabled class="form-control input-sm text-right" value="" style="width:70%">
                                            <?php } else { ?>
                                                <input id="Trucking" type="checkbox" class="form-check-input" disabled <?= ($details->Delivery_Permit != 0) ? 'checked' : '' ?>>&emsp;
                                                <input id="Trucking_Fee" type="number" min="1" disabled class="form-control input-sm text-right" value="<?= @$details->Delivery_Permit ?>" style="width:70%">
                                            <?php } ?>
                                        </div>
                                        <h6><i>(Enter the number of units)</i></h6>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Beach Resort Operator Fee:</label></br>
                                        <div class="form-inline">
                                            <?php if ($No_record) { ?>
                                                <input id="Beach" type="checkbox" class="form-check-input">&emsp;
                                                <input id="Beach_fee" type="number" min="1" disabled class="form-control input-sm text-right" value="" style="width:70%">
                                            <?php } else { ?>
                                                <input id="Beach" type="checkbox" class="form-check-input" disabled <?= ($details->Beach_Operator != 0) ? 'checked' : '' ?>>&emsp;
                                                <input id="Beach_fee" type="number" min="1" disabled class="form-control input-sm text-right" value="<?= $details->Beach_Operator ?>" style="width:70%">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <div class="form-group has-feedback">
                                            <input id="Username1" class="user-input form-control input-sm" placeholder="Username" type="text" autofocus>
                                            <span class="glyphicon glyphicon-user form-control-feedback"></span>
                                        </div>
                                        <div class="form-group has-feedback">
                                            <input id="Password1" class="user-input form-control input-sm" placeholder="Password" type="password">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn btn-danger btn-sm flat" id="Close_auth" style="display:none" data-dismiss="modal">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    table-condensed" cellspacing="0" width="100%">
                                        ...
                                        <thead style="font:bold 10px arial black, sans-serif;">
                                            <tr>
                                    ...
                                    <h5> * Please finalize all fees before clicking <font color="#367fa9">
                                            <b>SAVE</b>
                                        </font>. Editing of <b>PART I <i>(Assessment Details)</i>
...
<script language="javascript">
    ...
    var Assessment_ID = '<?php echo (empty($assessment->ID)) ? '' : $assessment->ID ?>'; // 02-23-2021
